...
public class SimpleQuery {
	...
	public static class Where implements IWhere {
		...
		public Where(String field, Operation operation, Object value) {
			this(field, operation, value, true);
		}
		
		public Where(String field, Operation operation, Object value, boolean transferred) {
			this(field, operation, new Object[] { value }, transferred);
		}
