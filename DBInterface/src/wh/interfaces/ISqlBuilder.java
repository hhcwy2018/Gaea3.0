...
public interface ISqlBuilder {
	...
	public enum Operation{
		otEqual, otUnequal, otGreater, otLess, otGreaterAndEqual, otLessAndEqual, otBetween, otLike, otIn, otNotIn, otNull, otNotNull
	}
	...
	void addWhere(String field, Operation operation, Object[] values, boolean transferred) throws NotSupportDBType;

	String getFieldValue(Object value, boolean transferred) throws NotSupportDBType;

	void addSet(String field, Object value, boolean transferred) throws NotSupportDBType;

	void addValue(Object value, boolean transferred) throws NotSupportDBType;
