...
import com.wh.gaea.control.requirement.ViewControl;
import com.wh.gaea.control.requirement.ViewControl.IEditing;
...
import com.wh.tools.EventHelp;

public class RequirementQueryDialog extends ChildForm implements IMainMenuOperation, ISubForm {
	 ...
	 * Create the dialog.
	 */
	public RequirementQueryDialog(IMainControl mainControl) {
		super(mainControl);
		setResizable(false);
