...
public class GaeaEditorManager implements IGaeaEditor {
	...
	public void mergeProject(String projectName, boolean mergeMainMenu, boolean mergeMainNav,
			...
			boolean mergeReport, boolean mergeDatasource, boolean mergeJS) {
		EditorEnvironment.mergeProject(projectName, mergeMainMenu, mergeMainNav, mergeImage, mergeHeader, mergeFooter,
				mergeLeftNav, mergeRightNav, mergeReport, mergeDatasource, mergeJS);
	}
	...
	public String getCurrentUserName() {
		return EditorEnvironment.getCurrentUserName();
	}

	@Override
	public File getResourcePath() {
		return EditorEnvironment.getEditorSourcePath();
	}

	@Override
	public File getResourcePath(String dirName) {
		return EditorEnvironment.getEditorSourcePath(dirName);
	}

	@Override
	public void completePublish() throws Throwable {
		getMainControl().completePublish();
	}

	@Override
	public void publish() throws Throwable {
		getMainControl().publish();
	}
