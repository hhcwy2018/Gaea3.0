package com.wh.gaea.install.dialog.help;
...
public class HelpDialog extends JDialog {
	public static String AppTitle = "系统";
	public static String VERSION = "v1.0";
	public static String Author = "王岩";
	public static String Email = "hhcwy@163.com";
	public static String ProtocolUrl = "hhcwy@163.com";
	public static String Copyright = "版权所有©" + new SimpleDateFormat("yyyy").format(new Date());
	private static final long serialVersionUID = 1L;
	private final JPanel contentPanel = new JPanel();

	public HelpDialog() {
		setTitle("关于" + AppTitle);
		...
		JLabel lblNewLabel_1 = new JLabel(Copyright + Author);
		lblNewLabel_1.setFont(new Font("微软雅黑", Font.PLAIN, 16));
		lblNewLabel_1.setBounds(210, 138, 188, 15);
		contentPanel.add(lblNewLabel_1);

		JLabel label = new JLabel("作者：" + Author);
		...
		JLabel lblEmail = new JLabel("邮箱：" + Email);
		...
		label_1.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				try {
					Runtime.getRuntime().exec("cmd.exe /c start " + "http://www.gnu.org/licenses/gpl-3.0.html");
				} catch (Exception ex) {
					ex.printStackTrace();
				}
			}
