...
public interface IEditorEnvironment {
	...
	public static final String Boot_Dir_Name = "boot";
	...
	public static final String Compile_Dir_Name = "compile";
	public static final String Install_Dir_Name = "setup";
	...
	public static final String Create_App_Config_FileName = "createapp.config";
	public static final String Boot_Class_FileName = "ClientProject.class";
	public static final String Boot_FileName = "boot";
